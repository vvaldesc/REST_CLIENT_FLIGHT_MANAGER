...
class VueloService {
    ...
    function request_curl() {
        $urlmiservicio = "http://localhost/_servWeb/UT7_3_Actividad3_RESTFul_Servidor/VueloServices.php/";
        $conexion = curl_init();
        //Url de la petición 
...
//GET con un dep 
    function request_uno($id) {
        $urlmiservicio = "http://localhost/_servWeb/UT7_3_Actividad3_RESTFul_Servidor/VueloServices.php/?id=" . $id;
        $conexion = curl_init();
        //Url de la petición 
        curl_setopt($conexion, CURLOPT_URL, $urlmiservicio);
        //Tipo de petición 
